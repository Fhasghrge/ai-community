...
export default function Community() {
  return (
    <div>
      <div className="flex justify-center items-center text-gray-300 my-4">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 mr-2 text-gray-300" fill="none" viewBox="0 0 24 24"
          stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
            d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
        </svg>
        <div className="border rounded border-gray-300">
          <input type="text" className='bg-transparent w-96 h-8 focus:outline-none focus:bg-gray-700' />
          <button className="border-l px-2">搜索</button>
        </div>
      </div>
      <div className="flex w-2/3 m-auto mt-2 space-x-2">
